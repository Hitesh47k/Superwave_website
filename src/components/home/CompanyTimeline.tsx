/**
 * File: CompanyTimeline.tsx
 * Purpose: Home section component: CompanyTimeline. Specific section used on the landing page.
 * 
 ...
 * 
 * Defines the CompanyTimeline component. Responsible for rendering the UI elements
      ...
      <div className="container-custom relative z-10" ref={containerRef}>
        ...
        <div className="hidden md:block relative">
          ...
          <div className="absolute right-0 top-[32px] translate-x-12 translate-y-2 animate-bounce pointer-events-none opacity-50">
             <div className="flex items-center gap-1 text-xs font-medium text-slate-500 glass backdrop-blur-sm px-2 py-1 rounded-full border-transparent">
        ...
        >
          <button 
            ...
            className="px-6 py-3 glass-card hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-900 dark:text-white border-transparent font-medium rounded-xl transition-all duration-300 shadow-sm hover:shadow-md flex items-center justify-center gap-2 card-hover"
          >
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[48px] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        <div className={`
          ...
          ${item.isCurrent ? 'bg-brand-600 text-white ring-4 ring-brand-100 dark:ring-brand-900/50' : 
            ...
            'glass-card border-2 border-slate-200 dark:border-slate-700 ' + item.text}
        `}>
          {item.icon}
        </div>
      </div>
      ...
      <div className={`w-full ${isAlt ? 'mt-[100px]' : 'mb-[100px] order-first'}`}>
        <div className={`
          p-5 rounded-2xl border glass-card/90 backdrop-blur-sm
...
function TimelineItemMobile({ item, index, onClick }: { key?: string | number, item: any, index: number, onClick: () => void }) {
  return (
    ...
    >
      ...
      {/* Card */}
      <div className={`
        flex-1 p-4 rounded-2xl border glass-card
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 sm:p-6">
      ...
      <motion.div 
        ...
        className={`
          relative w-full max-w-lg glass-panel shadow-2xl 
