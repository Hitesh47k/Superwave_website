...
const IMAGES = [
  ...
  "https://images.unsplash.com/photo-1673847401561-fcd73a78a946?q=80&w=800&auto=format&fit=crop",
  ...
  "https://images.unsplash.com/photo-1503694978374-8a2fa6873b21?q=80&w=800&auto=format&fit=crop",
  "https://images.unsplash.com/photo-1553877522-43269d4ea984?q=80&w=800&auto=format&fit=crop",
  "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=800&auto=format&fit=crop"
];

const NAMES = ["John Doe", "Alice Smith", "Michael Johnson", "David Lee", "Robert Vance", "Elena Rodriguez", "Olivia Parker", "James Bond", "Sarah Connor", "Emily Davis"];
const ROLES = ["Manager", "Engineer", "Director", "Specialist", "Coordinator", "Analyst", "Lead", "Technician"];
...
DEPARTMENTS.forEach(dept => {
  for (let i = 0; i < 8; i++) {
    ...
    media.push({
      ...
      src: isVideo ? "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4" : IMAGES[Math.floor(Math.random() * IMAGES.length)],
      thumbnail: isVideo ? IMAGES[Math.floor(Math.random() * IMAGES.length)] : undefined,
      title: `${dept} Update ${i + 1}`,
      categories: cats,
      department: dept,
      designation: ROLES[Math.floor(Math.random() * ROLES.length)],
      employeeName: Math.random() > 0.3 ? NAMES[Math.floor(Math.random() * NAMES.length)] : undefined,
      description: `Exploring the latest developments and team achievements in ${dept}.`,
...
const MEDIA: GalleryItem[] = ${JSON.stringify(media, null, 2)};
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 md:p-8 shadow-sm border border-slate-200 dark:border-slate-800 mb-10 space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
            <div className="relative w-full md:w-96 flex-shrink-0">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 text-slate-900 dark:text-white transition-all outline-none"
              />
            </div>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              <select 
                ...
                className="w-full md:w-auto px-4 py-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-700 dark:text-slate-300 focus:ring-2 focus:ring-brand-500 outline-none cursor-pointer font-medium"
              >
        ...
        {filteredMedia.length === 0 ? (
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="flex flex-col items-center justify-center py-24 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 border-dashed"
          >
